...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1521942387ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=portfolio&table=projects">`portfolio`.`projects`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=resetdb&table=fa2">`resetdb`.`fa2`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7254425726327b4b5b7342512a424f25">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="portfolio" targettable="projects">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `portfolio`.`projects` ( `id` INT NOT NULL AUTO_INCREMENT ,  `title` VARCHAR(255) NULL DEFAULT NULL ,  `p_language` VARCHAR(255) NULL DEFAULT NULL ,  `image` VARCHAR(255) NULL DEFAULT NULL ,  `date` DATE NULL DEFAULT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `projects`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="portfolio" targettable="projects">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `projects` (`id`, `title`, `p_language`, `image`, `date`) VALUES (NULL, &#039;sigmacrane.com&#039;, &#039;Wordpress&#039;, &#039;projects/sigma.php&#039;, &#039;2020-10-08&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="portfolio" targettable="projects">
                            <div class="action_content">
